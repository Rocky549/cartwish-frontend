...
const schema = z.object({
    name: z.string().min(3,{message:"Name must be atlest 3 charectors..."}).max(50),
    email: z.string().email({message:"Please enter valid email..."}),
    password: z.string().min(8,{message:"Password must be atlest 8 charectors..."}).max(50),
    cpassword: z.string(),
    deliveryAddress: z.string().min(15,{message:"Address must be atlest 15 charectors..."})
}).refine((data)=>data.password === data.cpassword,
{message:"Passwords must be same...", path:['cpassword']});
