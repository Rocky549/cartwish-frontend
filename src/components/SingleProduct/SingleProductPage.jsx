  ...
  return (
    <section className="align_center single_product">
        ...
        {product && <><div className="align_center">
            ...
            {product.images.map((image,index) => <img src={`${config.backendURL}/products/${image}`} alt={product.title} key={index} className={selectedImage===index?'selected_image':''} onClick={()=>SetSelectedImage(index)} />)}
            </div>
